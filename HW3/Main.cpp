...
// variables to keep track of orientation and scale
...
int main(int argc, char** argv)
{
	...
	static constexpr char const * window_title = "CPSC 453: HW3 Starter";
	...
	// check for any other features to enable
	// None for now
...

	{
		...
		if(argc != 4){
			VKL_EXIT_WITH_ERROR("Need to pass obj file, a texture file, and an ambient occlusion file as command line arguments");
		}
		...
		objectCreateGeometryAndBuffers(modelPath, texturePath, aoPath, window);
